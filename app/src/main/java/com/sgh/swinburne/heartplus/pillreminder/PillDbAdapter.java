...
{
    private static final String DATABASE_NAMER = "data";
    private static final String DATABASE_TABLER = "reminders";
    private static final int DATABASE_VERSIONR = 17;
    ...
    private static final String DATABASE_CREATER =
            "create table " + DATABASE_TABLER + " ("
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper
    {
        DatabaseHelper(Context context) {
            super(context, DATABASE_NAMER, null, DATABASE_VERSIONR);
        }

        @Override
        public void onCreate(SQLiteDatabase db) {

            db.execSQL(DATABASE_CREATER);
        }
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS " + DATABASE_TABLER);
            onCreate(db);
        }
    }
    ...
    public long createPill(String name, String dose, String instructions, String DateTime)
    {
        ...
        try {
        sd = Db.insert(DATABASE_TABLER, null, initValues);
        } catch (Exception e) {
    ...
    {
        return Db.delete(DATABASE_TABLER, KEY_RID + "=" + r_Id, null) > 0;
    }
    ...
    {
        return Db.query(DATABASE_TABLER, new String[] {KEY_RID, KEY_NAME, KEY_DOSE, KEY_INSTRUCTIONS, KEY_TIME}, null, null, null, null, null, null);
    }
    ...
    public Cursor fetchPills(long r_Id) throws SQLException //gets rowID to fetch pill
    {
        Cursor vcursr =
                ...
                Db.query(true, DATABASE_TABLER, new String[] {KEY_RID,
    ...
    public boolean updatePill(long r_Id, String name, String dose, String instructions, String DateTime)
    {
        ...
        return Db.update(DATABASE_TABLER, arg, KEY_RID + "=" + r_Id, null) > 0; //updating with new information
    }
    ...
    public long InsertRecord(String take, String snooze, String skip) {
        ...
        try {
            d = Db.insert(DATABASE_TABLER, null, values);
        } catch (Exception e) {
