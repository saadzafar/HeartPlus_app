package com.sgh.swinburne.heartplus.pillreminder.adapter;

/**
 * Created by faizan on 4/19/2016.
 */
...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        int colorSelected = _context.getResources().getColor(R.color.black);
        // The colors indicates the days of week when the alarm doesn't go off
        int colorNotSelected = Color.parseColor("#26ae90");
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            LayoutInflater infalInflater = (LayoutInflater) this._context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = infalInflater.inflate(R.layout.topbar, null);
        }
