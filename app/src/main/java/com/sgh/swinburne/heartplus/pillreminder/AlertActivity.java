...
/**
 * Created by faizan elahi on 4/20/2016.
 */
...
public class AlertActivity extends FragmentActivity {
    ...
    public void doNegativeClick(String pillName) {
        ...
        Toast.makeText(getBaseContext(), pillName + " was not taken at " + nonMilitaryHour + ":" + stringMinute + " " + am_pm + ".", Toast.LENGTH_SHORT).show();
        finish();
    }
}